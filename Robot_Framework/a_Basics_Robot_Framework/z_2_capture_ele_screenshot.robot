...
Handling Javascript Execution Custom
    ...
    capture element screenshot    ${web_ele}    click_me.png
    capture element screenshot    ${web_ele}    EMBED
    capture page screenshot    fullpage.png
    capture page screenshot    EMBED
    unselect frame
    sleep    2

Handling Javascript Execution Custom Headless Mode
    open browser    https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onclick   headlesschrome    options=add_argument("--ignore-certificate-errors")
    set browser implicit wait    10
    maximize browser window
    select frame    xpath://iframe[@id='iframeResult']
    ${web_ele}    get webelement    //button[normalize-space()='Click me']
